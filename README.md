# Taskflow3-Tarea2y1
    ...
    Intento 3. de proyecto desde cero en VISUAL STUDIO CODE, no en el VS 2019, el que estaba usando antes.

    Nombre del nuevo proyecto en github: Taskflow3-Tarea2y1
    referencia: https://github.com/JOSU0131/Taskflow3-Tarea2y1


Dia 10. Viernes 
    ## Paso 8. Ampliar TaskFlow con ayuda de IA
